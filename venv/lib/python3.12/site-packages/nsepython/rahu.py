...
def fnolist():
    nselist=['NIFTY','NIFTYIT','BANKNIFTY','FINNIFTY','MIDCPNIFTY']
    try:
        ...
        print(f"Error fetching FNO list: {e}. Using fallback.")
        # Fallback list of major FNO stocks
        fallback = [
            "RELIANCE", "TCS", "INFY", "HDFCBANK", "ICICIBANK", "AXISBANK", "SBIN", "BHARTIARTL",
            "ITC", "KOTAKBANK", "LT", "HINDUNILVR", "TATAMOTORS", "TATASTEEL", "BAJFINANCE",
            "MARUTI", "WIPRO", "HCLTECH", "SUNPHARMA", "ADANIENT", "ADANIPORTS", "COALINDIA"
        ]
        nselist.extend(fallback)
    return list(set(nselist))
